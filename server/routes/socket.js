...
const imgcodecs = require('../lib/processor/imgcodecs');
const imgDescriber = require('../lib/processor/imgDescriber');
const rotateFunc = require('../lib/processor/rotateFunc');
//1.相机标定
const camera = require('../lib/config/camera_param');
